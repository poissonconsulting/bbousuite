...
Statistical methods compared include a Bayesian model with year as fixed effect, Bayesian model with year as random effect, and frequentist retro model. 
See [this bboutools vignette](https://poissonconsulting.github.io/bboutools/articles/methods.html) for more details on statistical methods.
All Bayesian models had vague priors. 
...
Precision is simply the difference between the upper and lower limits of the 95% confidence intervals.
Coverage is the proportion of estimates for which the 95% confidence intervals contains the true value.
...
This simulation analysis demonstrates that this behaviour is desirable as the random effects model tends to be more skeptical of extreme values. 

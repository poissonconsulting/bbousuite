...
To fully explore estimators we also present simulations (citation) which allow assessment of bias and working characteristics across a full range of scenarios. 
...
To explore this question as well as overall performance of estimators we use simulations as presented in (*citation*).
